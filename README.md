...
Adds 3D textures to modded blocks
...
You can download 3D Default Compat on [Modrinth](https://modrinth.com/project/yHnAkckW) or [CurseForge](https://www.curseforge.com/minecraft/texture-packs/3d-default-compat)

## ⚙️ Requirements

You need the following resource pack for it to work properly:

- [3D Default](https://modrinth.com/project/5aPp18Lx)

## 🙏 Credits

- Thanks to [GeForceLegend](https://modrinth.com/user/MkdfqW2V) for [3D Default](https://modrinth.com/project/5aPp18Lx)

And a big thanks as well to every other mod creator!! Your mods make the game even more amazing.

## 🤝 Contributing

3D Default is a work in progress, and all suggestions are welcome.
...
Feel free to include 3D Default in modpacks.
